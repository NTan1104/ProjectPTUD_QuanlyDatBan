...
public class homeAll<mediaPlayerComponent, mediaPlayerComponent1> extends JFrame {
	...
	public <mediaPlayerComponent, mediaPlayerComponent1> void playVideo(String mediaPath) {
