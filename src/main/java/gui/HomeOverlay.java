...
public class HomeOverlay extends JWindow {
    ...
    public class PanelOverlay extends JPanel {
        ...
        private void init() {
            ...
            textTitle.putClientProperty(FlatClientProperties.STYLE, "font:bold +40;border:0,0,0,0");
            textDescription.setOpaque(false);
            textDescription.setEditable(false);
            textDescription.putClientProperty(FlatClientProperties.STYLE, "font:bold +2;border:0,0,0,0");
            cmdReadMore.putClientProperty(FlatClientProperties.STYLE,
                    "background:$Component.accentColor;borderWidth:0;margin:5,15,5,15;focusWidth:0;innerFocusWidth:0;arc:999");
            panel.add(textTitle);
        ...
        private void createHeader() {
            ...
            HeaderButton about = new HeaderButton("Thông tin");
            HeaderButton explore = new HeaderButton("Khám phá");
        ...
        private void createLogin() {
            panelLogin = new Login(mainFrame); // Truyền Main vào Login
