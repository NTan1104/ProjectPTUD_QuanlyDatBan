...
//        FlatRobotoFont.install();
        ...
        lblMessage.setForeground(new Color(120, 124, 126)); // Xám trung tính
    ...
    public void playVideo(String mediaPath) {
        ...
        if (mediaPlayerComponent != null) {
            ...
            if (videoFile.exists()) {
                ...
                mediaPlayerComponent.mediaPlayer().video().setScale(2); // Tự động co giãn theo kích thước container
