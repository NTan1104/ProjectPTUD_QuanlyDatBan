...
//			                homeNV homeMain = new homeNV();
//			                homeMain.removeAll();
//							panelDatBan panelDatBan = new panelDatBan();
//							panelDatBan.setVisible(true);
//							panelDatBan.setSize(homeMain.getWidth(),homeMain.getHeight());
//							homeMain.add(panelDatBan);
//							homeMain.revalidate();
//							homeMain.repaint();
//							
//						}
